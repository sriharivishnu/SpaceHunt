...
namespace TMPro.Examples
{
    ...
    public class TextMeshProFloatingText : MonoBehaviour
    {
        ...
        public IEnumerator DisplayTextMeshProFloatingText()
        {
            ...
            {
                current_Count -= (Time.smoothDeltaTime / CountDuration) * starting_Count;

                if (current_Count <= 3)
                {
                    //Debug.Log("Fading Counter ... " + current_Count.ToString("f2"));
                    alpha = Mathf.Clamp(alpha - (Time.smoothDeltaTime / fadeDuration) * 255, 0, 255);
                }
                ...
                m_floatingText_Transform.position += new Vector3(0, starting_Count * Time.smoothDeltaTime, 0);
